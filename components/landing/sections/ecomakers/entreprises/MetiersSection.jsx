        ...
        <div className="mx-auto max-w-5xl space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Spécialisation exclusive sur 6 métiers clés de la GTB/GTC et performance énergétique
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {metiers.map((metier, index) => {
              ...
              return (
                <div key={index} className="flex flex-col items-start gap-4 rounded-lg border bg-card p-6 hover:border-primary transition-colors">
